...
export default function AvailabilityPage() {
	...
	if (loading) {
		return <PageSkeleton backHref="/dashboard/profile" cardRowCount={8} />
	}
						...
						{DAYS.map((day, i) => {
							...
							return (
								<button
									...
									className={cn(
										"flex flex-col items-center justify-center rounded-xl border py-3 text-center transition-colors",
										isSelected
